"""ROS2 vision node for grounding_dino (grounding_dino_base)."""
...
class VisionNode(Node):
    def __init__(self):
        super().__init__('e2e_grounding_dino_node')
        self.get_logger().info('Initializing e2e_grounding_dino_node...')
        self.bridge = CvBridge()
        self._frame_count = 0

        # Declare parameters
        self.get_logger().info('Declaring parameters...')
        self.declare_parameter('default_prompt', 'person . car . dog . cat')
        ...
        self.get_logger().info('Creating model (GroundingDinoModel)...')
        t0 = time.monotonic()
        self.model = GroundingDinoModel(self)
        ...
        self.get_logger().info(
            'e2e_grounding_dino_node ready — grounding_dino:grounding_dino_base on cuda')
